...
module.exports = {
    flattenArray: function (arr) {
        if (Array.isArray(arr)) {
            ...
            return cleaned.reduce((currentState, nextValue) => currentState.concat(Array.isArray(nextValue) ? this.flattenArray(nextValue) : nextValue), []);
        }
        return false;
    },
...
//# sourceMappingURL=aninstance-helpers.js.map